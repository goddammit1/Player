...
///
/// * [date] — «по дате» (порядок добавления, `sort_order` из БД);
/// * [title] — по названию (A→Z);
/// * [artist] — по исполнителю (A→Z);
/// * [manual] — ручной порядок: отдельно хранимый список
///   [Playlist.manualOrder] (задаётся drag&drop), без дополнительной
///   сортировки и без реверса. Не влияет на остальные режимы.
